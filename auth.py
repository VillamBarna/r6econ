...
class Auth:
    ...
    async def connect(self, _new: bool = False) -> None:
        ...
        if "ticket" in data:
            ...
            print(f"[ Error in connect: \"{message}\" ]")
    ...
    async def try_query_db(self):
        ...
        try:
            ...
            print(res["errors"])
            failed = True
            print("Rate Limited! in try_query_db")
        except:
            pass
        if (failed or "httpCode" in res):
            return -1
